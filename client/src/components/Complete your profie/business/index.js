...
const CompleteProfileOTP = () => {
  ...
  //       const message = await axios.get('https://api.showcaseurbusiness.com/user/getotp', { headers:{ 'Authorization':t}})
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if (localStorage.getItem("details") == null) {
        navigate("/personal/forgotPassword");
      } else {
  ...
  const PostPhone = async (e) => {
    ...
    //     try{
    //     const response = await axios.post('https://api.showcaseurbusiness.com/user/verify', {phone:phone,}, { headers:{ 'Authorization':localStorage.getItem('token').replace(/"/g, '')}})
    //     if (response.data){
