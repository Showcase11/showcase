...
const CYP2 = () => {
  ...
  return (
    <div className="cyp2">
      ...
      <div className="col-2">
        <img src="/circle.png" style={{ float: "left", marginTop: "100px", marginLeft: "-105px" }} alt=''/>
      </div>
      ...
      <form onSubmit={CompleteDetail} className="container">
        ...
        <hr />
        <div className="form-group" style={{ textAlign: "center" }}>
          <label htmlFor="ph.no" style={{ paddingRight: "30%" }}>
            <b>Phone number</b>
          </label>
          <br />
          <input
        ...
        <div className="form-group" style={{ textAlign: "center" }}>
          <label htmlFor="address" style={{ paddingRight: "31%" }}>
            <b>Your address</b>
          </label>
          <br />
          <input
        ...
        <div className="form-group" style={{ textAlign: "center" }}>
          <label htmlFor="country" style={{ paddingRight: "26%" }}>
          ...
          >
            <option defaultValue="please" value="please">
        ...
        <div className="form-group" style={{ textAlign: "center" }}>
          <p>
            {" "}
            <i className="material-icons">lock_outline</i> Your info is safely
            secured
          </p>
        </div>
      </form>
